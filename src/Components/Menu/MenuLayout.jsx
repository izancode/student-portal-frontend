...
export const HomeMenu = () => {
  return (
    <div className=" px-2 lg:max-w-[1200px] mx-auto h-[calc(100vh-50px)] sm:h-[calc(100vh-70px)] flex items-center">
...
export const SideBarMenu = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex h-screen lg:h-[calc(100vh-189px)] lg:px-1 text-white overflow-auto ">
